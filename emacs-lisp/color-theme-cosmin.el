...
(defun color-theme-cosmin ()
  "Designed to look similar to 'emacs --no-window-system'. It is based on a theme made by Suvayu Ali"
  (interactive)
  (let ((color-theme-is-cumulative nil))
	...
	(view-highlight-face . highlight))
       ...
       (font-lock-comment-delimiter-face ((t (:italic t :foreground "firebrick1" :background "black" :slant italic ))))
       (font-lock-comment-face ((t (:italic t :slant italic :background "black" :foreground "firebrick1" ))))
       ...
       (font-lock-keyword-face ((t (:background "black" :foreground "cyan3" ))))
       ...
       (font-lock-variable-name-face ((t (:background "black" :foreground "gold" ))))
...
(add-to-list 'color-themes '(color-theme-cosmin  "Cosmin" "Cosmin Stejerean"))
